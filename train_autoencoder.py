...
def main():
    ...
    params = list(model.pool.parameters()) + list(model.fc1.parameters()) + list(model.fc2.parameters())
    params = params + list(model.fc3.parameters()) + list(model.deconv.parameters())
