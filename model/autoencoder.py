...
class Autoencoder(nn.Module):
    ...
    def init_weights(self):
        ...
        nn.init.normal_(self.fc2.weight, 0.0, sqrt(0.01 / 128))
        nn.init.constant(self.fc2.bias, 0.01)
        nn.init.normal_(self.fc3.weight, 0.0, sqrt(0.01 / 64))
        nn.init.constant(self.fc3.bias, 0.01)
        nn.init.normal_(self.deconv.weight, 0.0, 0.01)
        nn.init.constant(self.deconv.bias, 0.0)
